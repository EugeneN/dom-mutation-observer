...
(function() {
  var $, MutationObserver, debug, dispatch_impl, error, info, isDOMAttrModifiedSupported, nullog, observe, observe_dom_added, pubsubhub, root, warn, _ref,
  ...
  observe_dom_added = function(root_node, cont) {
    var dom_parser, get_wrapper, patch, pub, sub, _ref1;
